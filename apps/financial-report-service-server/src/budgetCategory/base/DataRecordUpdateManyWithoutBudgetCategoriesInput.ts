...
@InputType()
class DataRecordUpdateManyWithoutBudgetCategoriesInput {
...
export { DataRecordUpdateManyWithoutBudgetCategoriesInput as DataRecordUpdateManyWithoutBudgetCategoriesInput };
